import type { CommandData, CommandExecuteResult, SimplifiedInteraction } from "../utils/types";
...
export default {
    ...
    async execute(data: { interaction: SimplifiedInteraction }): CommandExecuteResult {
        return {
