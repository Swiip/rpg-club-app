...
import type { MessageFlags, RESTPostAPIApplicationCommandsJSONBody } from "discord.js";
...
export type CommandExecute = (data: { interaction: SimplifiedInteraction }) => CommandExecuteResult;
